...
void F_LED(){
  ...
  switch(case_F){
    ...
    digitalWrite(F_LED_PIN,F_LED_STATE);
    }
...
void loop()
{
    ...
    while(0==0){
     IMU();
            msg[0]=255;     
            msg[1]=map(ypr[0] * 180/M_PI,-90 , 90 , 0 , 254);
            msg[2]=map(ypr[1] * 180/M_PI,-90 , 90 , 0 , 254);
            msg[3]=map(ypr[2] * 180/M_PI,-90 , 90 , 0 , 254);
            msg[4]=0;
            Serial.print(msg[1]);
            Serial.print("\t");
            Serial.print(msg[2]);
